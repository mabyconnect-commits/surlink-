    ...
    <div className="fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-[var(--muted-foreground)]">
          Sign in to continue to Surlink
        </p>
      </div>
      ...
      <div className="mt-6 p-4 bg-[var(--secondary)] rounded-lg">
        <p className="text-sm text-center text-[var(--muted-foreground)] mb-2">
          Demo Credentials
        </p>
        <div className="space-y-1 text-xs text-center">
          <p><strong>Customer:</strong> customer@demo.com</p>
          <p><strong>Provider:</strong> provider@demo.com</p>
          <p className="text-[var(--muted-foreground)]">Password: demo123</p>
        </div>
      </div>
    </div>
  );
